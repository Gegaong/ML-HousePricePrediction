...
ეს პროექტი წარმოადგენს Kaggle-ის კონკურსს — **"House Prices: Advanced Regression Techniques"**. ამოცანა შემდეგია: მოცემული გვაქვს საცხოვრებელი სახლების მონაცემები (80 მახასიათებელი) და გვჭირდება **SalePrice**-ის პროგნოზი.
...
Best Params:
  reg_lambda: 5.0
  reg_alpha: 0.1
  num_leaves: 15       ← overfitting-ის თავიდან ასაცილებლად
